...
based on their city and topic preferences. Unlike the email_sender.py
...
matching their selected topics.
"""
...
def dispatch_emails_to_subscribers(
    ...
    """
    Query all subscribers and send each a personalized, topic-filtered report.

    This function:
    1. Validates that reports is not empty
    2. Queries subscribers with their city and topic preferences
    3. Combines matching topic reports into a single personalized email
    4. Tracks delivery statistics and failures
